...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-a6osmby.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-a6osmby.containers.anotherwebservice.com/
...
```
git clone git@github.com:FavoShane/container-a6osmby.git
cd container-a6osmby
```
...
```
docker attach container-a6osmby
```
